...
{
    [DbContext(typeof(Foodbook.Data.AppDbContext))]
    [Migration("20260307120000_AddFoodbookTemplates")]
    public partial class AddFoodbookTemplates : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodbookTemplates_UserId_Name",
        ...
        {
            migrationBuilder.DropTable(name: "TemplateMeals");
            migrationBuilder.DropTable(name: "FoodbookTemplates");
        }
    }
}
