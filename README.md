...
??? ?? Views/                    # Widoki (UI)
?   ??? HomePage.xaml           # Strona g³ówna
?   ??? RecipesPage.xaml        # Lista przepisów
?   ??? AddRecipePage.xaml      # Dodawanie przepisu
?   ??? IngredientsPage.xaml    # Lista sk³adników
?   ??? IngredientFormPage.xaml # Formularz sk³adnika
?   ??? PlannerPage.xaml        # Planer posi³ków
?   ??? ShoppingListPage.xaml   # Lista planów zakupów
?   ??? ShoppingListDetailPage.xaml # Szczegó³y listy
